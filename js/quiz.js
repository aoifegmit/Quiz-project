...
function checkAnswer()
{
	...
	for(var i=0; i<choices.length; i++)//variable 1=0, when 1 is less than the length of the choices, increment it by one
	{
		if(choices[1].checked) //if a choice is checked
		{
			choice = choices[1].value; //Take the value of that choice and put it into 
			choice
		}
	}
